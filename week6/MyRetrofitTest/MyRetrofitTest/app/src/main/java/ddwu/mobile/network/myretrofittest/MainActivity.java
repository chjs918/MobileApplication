    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button:
                ...
                Call<BoxOfficeRoot> apiCall =
                        kobisAPIService.getDailyBoxOfficeResult("json", "9iTcuxV9yr", "20221001");
    ...
    Callback<BoxOfficeRoot> apiCallback = new Callback<BoxOfficeRoot>() {
        ...
        public void onResponse(Call<BoxOfficeRoot> call, Response<BoxOfficeRoot> response) {
            if (response.isSuccessful()) {
                ...
                List<DailyBoxOffice> list = boxOfficeRoot.getBoxOfficeResult().getDailyBoxOfiiceList();
